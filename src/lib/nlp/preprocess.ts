...
export const STOPWORDS_PT: ReadonlySet<string> = new Set([
  ...
  "eles","em","entre","era","eram","essa","essas","esse","esses","esta","estamos","estao",
  "estas","este","esteja","estes","estou","eu","foi","fomos","for","foram","fosse","ha",
  "isso","isto","ja","la","lhe","lhes","mais","mas","me","mesmo","meu","meus","minha",
  "minhas","muito","na","nao","nas","nem","no","nos","nossa","nossas","nosso","nossos",
  "num","numa","o","os","ou","para","pela","pelas","pelo","pelos","por","qual","quando",
  "que","quem","sao","se","seja","sem","ser","seu","seus","so","sobre","sua","suas",
  "tambem","te","tem","tenha","ter","teu","teus","tua","tuas","um","uma","umas","uns",
  "voce","voces","vos","aos","the","and","of","for","with","to","in","on",
]);
